...
{
    infile.open("/home/johanna/waypoints.txt");
}
...
{
    fp_pos = fopen("/home/johanna/traj_p.txt", "w+");
    fp_vel = fopen("/home/johanna/traj_v.txt", "w+");
    fp_acc = fopen("/home/johanna/traj_a.txt", "w+");
}
...
int main(int argc, char **argv)
{
    ...
    // minJerkTraj.checkMaxVelRate(15.0);
